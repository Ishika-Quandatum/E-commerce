                ...
                orders.map((o) => (
                  <tr key={o.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{o.user?.first_name} {o.user?.last_name}</div>
                      <div className="text-xs text-gray-500">{o.user?.email || `User #${o.user}`}</div>
                    </td>
